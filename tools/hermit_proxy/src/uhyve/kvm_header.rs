...
impl kvm_regs {
    pub fn empty() ->kvm_regs {
        kvm_regs {
            rax: 0,rbx: 0,rcx: 0, rdx: 0, rsi: 0,rdi:0, rsp: 0,rbp: 0, r8: 0, r9: 0,r10: 0, r11: 0, r12: 0,r13:0, r14: 0,r15: 0,rip: 0, rflags: 0
        }
    }
}
...
impl kvm_segment {
    pub fn empty() -> kvm_segment {
        kvm_segment {
            base: 0, limit: 0, selector:  0, type_: 0, present:  0, dpl: 0, db: 0,s: 0, l: 0,g:0, avl: 0, unusable: 0, padding: 0 
        }
    }
}
#[test]
...
impl kvm_cpuid_entry2 {
    pub fn empty() -> kvm_cpuid_entry2 {
        kvm_cpuid_entry2 {
            function: 0,
            index: 0,
            flags: 0,
...
fn bindgen_test_layout_kvm_vcpu_events__bindgen_ty_4() {
    assert_eq!(::std::mem::size_of::<kvm_vcpu_events__bindgen_ty_4>() , 4usize
               , concat ! (
               "Size of: " , stringify ! ( kvm_vcpu_events__bindgen_ty_4 ) ));
    assert_eq! (::std::mem::align_of::<kvm_vcpu_events__bindgen_ty_4>() ,
                1usize , concat ! (
                "Alignment of " , stringify ! ( kvm_vcpu_events__bindgen_ty_4
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_vcpu_events__bindgen_ty_4 ) ) . smm
                as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_vcpu_events__bindgen_ty_4 ) , "::" , stringify ! ( smm )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_vcpu_events__bindgen_ty_4 ) ) .
                pending as * const _ as usize } , 1usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_vcpu_events__bindgen_ty_4 ) , "::" , stringify ! ( pending
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_vcpu_events__bindgen_ty_4 ) ) .
                smm_inside_nmi as * const _ as usize } , 2usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_vcpu_events__bindgen_ty_4 ) , "::" , stringify ! (
                smm_inside_nmi ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_vcpu_events__bindgen_ty_4 ) ) .
                latched_init as * const _ as usize } , 3usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_vcpu_events__bindgen_ty_4 ) , "::" , stringify ! (
                latched_init ) ));
}
impl Clone for kvm_vcpu_events__bindgen_ty_4 {
    fn clone(&self) -> Self { *self }
}
#[test]
fn bindgen_test_layout_kvm_vcpu_events() {
    ...
    assert_eq! (unsafe {
                ...
                "::" , stringify ! ( flags ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_vcpu_events ) ) . smi as * const _ as
...
fn bindgen_test_layout_kvm_s390_skeys() {
    assert_eq!(::std::mem::size_of::<kvm_s390_skeys>() , 64usize , concat ! (
               "Size of: " , stringify ! ( kvm_s390_skeys ) ));
    assert_eq! (::std::mem::align_of::<kvm_s390_skeys>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( kvm_s390_skeys ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_skeys ) ) . start_gfn as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_skeys ) , "::"
                , stringify ! ( start_gfn ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_skeys ) ) . count as * const _
                as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_skeys ) , "::"
                , stringify ! ( count ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_skeys ) ) . skeydata_addr as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_skeys ) , "::"
                , stringify ! ( skeydata_addr ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_skeys ) ) . flags as * const _
                as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_skeys ) , "::"
                , stringify ! ( flags ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_skeys ) ) . reserved as * const
                _ as usize } , 28usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_skeys ) , "::"
                , stringify ! ( reserved ) ));
}
impl Clone for kvm_s390_skeys {
    fn clone(&self) -> Self { *self }
}
#[repr(C)]
#[derive(Copy)]
...
fn bindgen_test_layout_kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_1() {
    ...
    assert_eq! (::std::mem::align_of::<kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_1>()
                , 8usize , concat ! (
                "Alignment of " , stringify ! (
                kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_1 ) ));
    assert_eq! (unsafe {
                & (
                * ( 0 as * const kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_1 )
                ) . msr as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_1 ) , "::" ,
                stringify ! ( msr ) ));
    assert_eq! (unsafe {
                & (
                * ( 0 as * const kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_1 )
                ) . control as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_1 ) , "::" ,
                stringify ! ( control ) ));
    assert_eq! (unsafe {
    ...
    assert_eq! (unsafe {
                & (
                * ( 0 as * const kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_1 )
                ) . msg_page as * const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_1 ) , "::" ,
                stringify ! ( msg_page ) ));
}
...
fn bindgen_test_layout_kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_2() {
    assert_eq!(::std::mem::size_of::<kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_2>()
               , 32usize , concat ! (
               "Size of: " , stringify ! (
               kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_2 ) ));
    assert_eq! (::std::mem::align_of::<kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_2>()
                , 8usize , concat ! (
                "Alignment of " , stringify ! (
                kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_2 ) ));
    assert_eq! (unsafe {
                & (
                * ( 0 as * const kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_2 )
    ...
    assert_eq! (unsafe {
                & (
                * ( 0 as * const kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_2 )
                ) . result as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_2 ) , "::" ,
                stringify ! ( result ) ));
    assert_eq! (unsafe {
                & (
                * ( 0 as * const kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_2 )
                ) . params as * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_2 ) , "::" ,
                stringify ! ( params ) ));
}
impl Clone for kvm_hyperv_exit__bindgen_ty_1__bindgen_ty_2 {
    fn clone(&self) -> Self { *self }
}
#[test]
fn bindgen_test_layout_kvm_hyperv_exit__bindgen_ty_1() {
    assert_eq!(::std::mem::size_of::<kvm_hyperv_exit__bindgen_ty_1>() ,
               32usize , concat ! (
               "Size of: " , stringify ! ( kvm_hyperv_exit__bindgen_ty_1 ) ));
    assert_eq! (::std::mem::align_of::<kvm_hyperv_exit__bindgen_ty_1>() ,
                8usize , concat ! (
                "Alignment of " , stringify ! ( kvm_hyperv_exit__bindgen_ty_1
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_hyperv_exit__bindgen_ty_1 ) ) . synic
                as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_hyperv_exit__bindgen_ty_1 ) , "::" , stringify ! ( synic )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_hyperv_exit__bindgen_ty_1 ) ) . hcall
                as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_hyperv_exit__bindgen_ty_1 ) , "::" , stringify ! ( hcall )
                ));
}
impl Clone for kvm_hyperv_exit__bindgen_ty_1 {
    fn clone(&self) -> Self { *self }
}
#[test]
fn bindgen_test_layout_kvm_hyperv_exit() {
    assert_eq!(::std::mem::size_of::<kvm_hyperv_exit>() , 40usize , concat ! (
               "Size of: " , stringify ! ( kvm_hyperv_exit ) ));
    assert_eq! (::std::mem::align_of::<kvm_hyperv_exit>() , 8usize , concat !
                ( "Alignment of " , stringify ! ( kvm_hyperv_exit ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_hyperv_exit ) ) . type_ as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_hyperv_exit ) ,
                "::" , stringify ! ( type_ ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_hyperv_exit ) ) . u as * const _ as
                usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_hyperv_exit ) ,
                "::" , stringify ! ( u ) ));
}
impl Clone for kvm_hyperv_exit {
    fn clone(&self) -> Self { *self }
}
#[repr(C)]
pub struct kvm_run {
...
fn bindgen_test_layout_kvm_run__bindgen_ty_1__bindgen_ty_18() {
    assert_eq!(::std::mem::size_of::<kvm_run__bindgen_ty_1__bindgen_ty_18>() ,
               16usize , concat ! (
               "Size of: " , stringify ! (
               kvm_run__bindgen_ty_1__bindgen_ty_18 ) ));
    assert_eq! (::std::mem::align_of::<kvm_run__bindgen_ty_1__bindgen_ty_18>()
                , 8usize , concat ! (
                "Alignment of " , stringify ! (
                kvm_run__bindgen_ty_1__bindgen_ty_18 ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_run__bindgen_ty_1__bindgen_ty_18 ) )
                . addr as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_run__bindgen_ty_1__bindgen_ty_18 ) , "::" , stringify ! (
                addr ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_run__bindgen_ty_1__bindgen_ty_18 ) )
                . ar as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_run__bindgen_ty_1__bindgen_ty_18 ) , "::" , stringify ! (
                ar ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_run__bindgen_ty_1__bindgen_ty_18 ) )
                . reserved as * const _ as usize } , 9usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_run__bindgen_ty_1__bindgen_ty_18 ) , "::" , stringify ! (
                reserved ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_run__bindgen_ty_1__bindgen_ty_18 ) )
                . fc as * const _ as usize } , 10usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_run__bindgen_ty_1__bindgen_ty_18 ) , "::" , stringify ! (
                fc ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_run__bindgen_ty_1__bindgen_ty_18 ) )
                . sel1 as * const _ as usize } , 11usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_run__bindgen_ty_1__bindgen_ty_18 ) , "::" , stringify ! (
                sel1 ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_run__bindgen_ty_1__bindgen_ty_18 ) )
                . sel2 as * const _ as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_run__bindgen_ty_1__bindgen_ty_18 ) , "::" , stringify ! (
                sel2 ) ));
}
impl Clone for kvm_run__bindgen_ty_1__bindgen_ty_18 {
    fn clone(&self) -> Self { *self }
}
#[repr(C)]
#[derive(Debug, Copy)]
...
fn bindgen_test_layout_kvm_run__bindgen_ty_1__bindgen_ty_19() {
    ...
    assert_eq! (::std::mem::align_of::<kvm_run__bindgen_ty_1__bindgen_ty_19>()
                , 1usize , concat ! (
                "Alignment of " , stringify ! (
                kvm_run__bindgen_ty_1__bindgen_ty_19 ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_run__bindgen_ty_1__bindgen_ty_19 ) )
                . vector as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_run__bindgen_ty_1__bindgen_ty_19 ) , "::" , stringify ! (
                vector ) ));
}
impl Clone for kvm_run__bindgen_ty_1__bindgen_ty_19 {
    fn clone(&self) -> Self { *self }
}
#[test]
fn bindgen_test_layout_kvm_run__bindgen_ty_1() {
    ...
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_run__bindgen_ty_1 ) ) . s390_stsi as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_run__bindgen_ty_1 )
                , "::" , stringify ! ( s390_stsi ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_run__bindgen_ty_1 ) ) . eoi as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_run__bindgen_ty_1 )
                , "::" , stringify ! ( eoi ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_run__bindgen_ty_1 ) ) . hyperv as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_run__bindgen_ty_1 )
                , "::" , stringify ! ( hyperv ) ));
    assert_eq! (unsafe {
...
fn bindgen_test_layout_kvm_run__bindgen_ty_2() {
    assert_eq!(::std::mem::size_of::<kvm_run__bindgen_ty_2>() , 2048usize ,
...
fn bindgen_test_layout_kvm_run() {
    assert_eq!(::std::mem::size_of::<kvm_run>() , 2352usize , concat ! (
    ...
    assert_eq! (unsafe {
                ...
                stringify ! ( if_flag ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_run ) ) . flags as * const _ as usize
                } , 14usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_run ) , "::" ,
                stringify ! ( flags ) ));
    assert_eq! (unsafe {
...
fn bindgen_test_layout_kvm_s390_mem_op() {
    assert_eq!(::std::mem::size_of::<kvm_s390_mem_op>() , 64usize , concat ! (
               "Size of: " , stringify ! ( kvm_s390_mem_op ) ));
    assert_eq! (::std::mem::align_of::<kvm_s390_mem_op>() , 8usize , concat !
                ( "Alignment of " , stringify ! ( kvm_s390_mem_op ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_mem_op ) ) . gaddr as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_mem_op ) ,
                "::" , stringify ! ( gaddr ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_mem_op ) ) . flags as * const _
                as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_mem_op ) ,
                "::" , stringify ! ( flags ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_mem_op ) ) . size as * const _
                as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_mem_op ) ,
                "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_mem_op ) ) . op as * const _ as
                usize } , 20usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_mem_op ) ,
                "::" , stringify ! ( op ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_mem_op ) ) . buf as * const _ as
                usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_mem_op ) ,
                "::" , stringify ! ( buf ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_mem_op ) ) . ar as * const _ as
                usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_mem_op ) ,
                "::" , stringify ! ( ar ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_mem_op ) ) . reserved as * const
                _ as usize } , 33usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_mem_op ) ,
                "::" , stringify ! ( reserved ) ));
}
impl Clone for kvm_s390_mem_op {
    fn clone(&self) -> Self { *self }
}
#[repr(C)]
#[derive(Debug, Copy)]
...
fn bindgen_test_layout_kvm_s390_pgm_info() {
    ...
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_pgm_info ) ) . flags as * const
...
fn bindgen_test_layout_kvm_s390_irq_state() {
    assert_eq!(::std::mem::size_of::<kvm_s390_irq_state>() , 32usize , concat
               ! ( "Size of: " , stringify ! ( kvm_s390_irq_state ) ));
    assert_eq! (::std::mem::align_of::<kvm_s390_irq_state>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( kvm_s390_irq_state ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_irq_state ) ) . buf as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_irq_state ) ,
                "::" , stringify ! ( buf ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_irq_state ) ) . flags as * const
                _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_irq_state ) ,
                "::" , stringify ! ( flags ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_irq_state ) ) . len as * const _
                as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_irq_state ) ,
                "::" , stringify ! ( len ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_s390_irq_state ) ) . reserved as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_s390_irq_state ) ,
                "::" , stringify ! ( reserved ) ));
}
impl Clone for kvm_s390_irq_state {
    fn clone(&self) -> Self { *self }
}
#[repr(C)]
#[derive(Debug, Copy)]
...
pub const kvm_ioeventfd_flag_nr_datamatch: _bindgen_ty_1 =
    _bindgen_ty_1::kvm_ioeventfd_flag_nr_datamatch;
pub const kvm_ioeventfd_flag_nr_pio: _bindgen_ty_1 =
    _bindgen_ty_1::kvm_ioeventfd_flag_nr_pio;
pub const kvm_ioeventfd_flag_nr_deassign: _bindgen_ty_1 =
    _bindgen_ty_1::kvm_ioeventfd_flag_nr_deassign;
pub const kvm_ioeventfd_flag_nr_virtio_ccw_notify: _bindgen_ty_1 =
    _bindgen_ty_1::kvm_ioeventfd_flag_nr_virtio_ccw_notify;
pub const kvm_ioeventfd_flag_nr_fast_mmio: _bindgen_ty_1 =
    _bindgen_ty_1::kvm_ioeventfd_flag_nr_fast_mmio;
pub const kvm_ioeventfd_flag_nr_max: _bindgen_ty_1 =
    _bindgen_ty_1::kvm_ioeventfd_flag_nr_max;
#[repr(u32)]
...
fn bindgen_test_layout_kvm_irq_routing_hv_sint() {
    assert_eq!(::std::mem::size_of::<kvm_irq_routing_hv_sint>() , 8usize ,
               concat ! (
               "Size of: " , stringify ! ( kvm_irq_routing_hv_sint ) ));
    assert_eq! (::std::mem::align_of::<kvm_irq_routing_hv_sint>() , 4usize ,
                concat ! (
                "Alignment of " , stringify ! ( kvm_irq_routing_hv_sint ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_irq_routing_hv_sint ) ) . vcpu as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_irq_routing_hv_sint
                ) , "::" , stringify ! ( vcpu ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_irq_routing_hv_sint ) ) . sint as *
                const _ as usize } , 4usize , concat ! (
                "Alignment of field: " , stringify ! ( kvm_irq_routing_hv_sint
                ) , "::" , stringify ! ( sint ) ));
}
impl Clone for kvm_irq_routing_hv_sint {
    fn clone(&self) -> Self { *self }
}
#[repr(C)]
#[derive(Copy)]
...
fn bindgen_test_layout_kvm_irq_routing_entry__bindgen_ty_1() {
    ...
    assert_eq! (unsafe {
                & ( * ( 0 as * const kvm_irq_routing_entry__bindgen_ty_1 ) ) .
                hv_sint as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                kvm_irq_routing_entry__bindgen_ty_1 ) , "::" , stringify ! (
                hv_sint ) ));
    assert_eq! (unsafe {
