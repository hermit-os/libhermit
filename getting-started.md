...
3. After a reboot of the system, register the HermitCore loader at your system with following command: `sudo sh -c 'echo ":hermit:M:7:\\x42::/path2proyxy/proxy:" > /proc/sys/fs/binfmt_misc/register'`, in which `path2proxy` defines the path to the loader.
